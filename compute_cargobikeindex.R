...
# env.R file with database info
#  dbname = pg_db, host = pg_host, user = pg_user, password = pg_password
source(here("R", "env.R"))
...
# iterate bc loading of entire db at once is too large
input_intervall_step <- 1000000
input_intervall_min <- 1
input_intervall_max <- 0
